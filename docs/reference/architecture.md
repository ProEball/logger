...
- `shared/services/`, `shared/hooks/`, `shared/types/`, `shared/utils/` — generic reusable code (note: `shared/services/logger.ts` exists but is currently unused/dead code, see [misc.md](misc.md#app-logger)).
