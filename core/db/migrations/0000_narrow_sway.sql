...
ALTER TABLE "project_member_roles" ADD CONSTRAINT "project_member_roles_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_member_roles" ADD CONSTRAINT "project_member_roles_role_id_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."roles"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "invitations_email_org_pending_idx" ON "invitations" USING btree ("email","organization_id") WHERE "invitations"."accepted_at" IS NULL;